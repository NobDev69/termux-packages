...
# Path to CGCT tools
CGCT_DEFAULT_PREFIX="/data/data/com.termux.oneshot/files/usr/glibc"
export CGCT_DIR="/data/data/com.termux.oneshot/cgct"
...
TERMUX_REPO_PACKAGE="com.termux.oneshot"
